...
{				
	...
	{	
		...
		$this->load_resource( 'KObserver', '/interface/KObserver.php' );		
	}
	...
	{
		$this->load_resource( 'XmlDomConstruct', '/library/XmlDomConstruct.php' );
		...
		if( !empty( $this->observers ) ){
			foreach( $this->observers as $observer ){
				if( method_exists( $observer, $event ) ){
					call_user_func_array( array( $observer, $event ), $arguments );
	...
	public function kc_on_error(  $code, $message )
	{	
